...
{
    $request = $_POST['level5'];
    $col = $_POST['col5'];
    $year = $_POST['thisyear5'];
...
<div class="tableContainer">
    ...
    <h4>A.2. Research Publication</h4>
        ...
        <tbody>
            ...
            header("Content-Disposition:attachment; filename=$col $displayyear Level:$request Research Publication Titles.xls");
            $i = 1;
            $n = null;
            while($row1 = mysqli_fetch_assoc($result3))
            {
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo $row1['RpIndexingPlatform'];?></td>
                        <td style="text-align:left;"><?php echo $row1['RpDatePublished'];?></td>
                        <td style="text-align:left;"><?php echo $row1['RpPublisher'];?></td>
                        <td style="text-align:left;"><?php echo $row1['RpEditor'];?></td>
