...
?>
    ...
    <input id="call" type="hidden" value="<?php echo $exportcall; ?>">
    <input id="collegename" type="hidden" value="<?php echo $college; ?>">
    <input id="quartername" type="hidden" value="<?php echo $quarterid; ?>">
        <?php if($count){?>
    ...
    <script>
        ...
        $('#thiscollege').val($('#collegename').val());
        $('#thisquarter').val($('#quartername').val());
        $('#num').val($('#call').val());
