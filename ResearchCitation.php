...
$resul = $con->query("SELECT CitationId FROM researchcitation WHERE SubmissionId = (SELECT SubmissionId FROM submission WHERE UserId = '$test' AND (SubmissionStatus = 'Ongoing' OR SubmissionStatus = 'Submitted') AND QuarterId = (SELECT QuarterId FROM quarter WHERE QuarterProgress='Ongoing')) ORDER BY CitationId DESC");
$resul2 = $con->query("SELECT CitationId FROM researchcitation WHERE SubmissionId = (SELECT SubmissionId FROM submission WHERE UserId = '$test' AND (SubmissionStatus = 'Ongoing' OR SubmissionStatus = 'Submitted') AND QuarterId = (SELECT QuarterId FROM quarter WHERE QuarterProgress='Ongoing'))");
...
<section id="part-banner-specific">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h4 class="pageTitle">A.4. Research Citation</h4>
            </div>
        </div>
    </div>
</section>
...
<div class="Form-Group1">
                     ...
                     $recordcounter = mysqli_num_rows($resul);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if($addstat == 1)
                                    {
                                        $pick = "SELECT CitationId FROM researchcitation ORDER BY CitationId DESC LIMIT 1";
    ...
    <form name="actorInsert" onSubmit="return ValidateActInsert()" action="Insert/ResearchCitationInsert.php" method="POST" enctype="multipart/form-data">
        <?php
            ...
            {
                $queryr = "SELECT CitationId FROM researchcitation ORDER BY CitationId DESC";
            ...
            $query = "SELECT * FROM researchcitation WHERE CitationId = '$record'";
            ...
            if(mysqli_num_rows($query_run)>0)
            {
                foreach($query_run as $row)
                {
                    $title = $row['RcTitle'];
                    $class =  $row['RcClass'];
                    $category =  $row['RcCategory'];
                    $agenda =  $row['RcAgenda'];
                    $involve =  $row['RcInvolve'];
                    $type =  $row['RcType'];
                    $fundtype =  $row['RcFundType'];
                    $fundamount =  $row['RcFundAmount'];
                    $fundagency =  $row['RcFundAgency'];
                    $datestart = $row['RcDateStart'];
                    $datetarget = $row['RcDateTarget'];
                    $datecomplete = $row['RcDateCompleted'];
                    $article = $row['RcArticleCited'];
                    $research = $row['RcResearchCitedBy'];
                    $authors = $row['RcAuthorsCitedBy'];
                    $journals = $row['RcJournalsCitedBy'];
                    $volno = $row['RcVolNo'];
                    $issue = $row['RcJournalIssue'];
                    $journalpage = $row['RcJournalPage'];
                    $journalyear = $row['RcJournalYear'];
                    $journalpublisher = $row['RcJournalPublisher'];
                    $journalindexing = $row['RcJournalIndexing'];
                    $file = $row['RcTempName'];
                    $original = $row['RcFilename'];
                    $change = $row['CitationId'];
                }
            }
        ...
        <div class="form-group">
            <div class="col-md-11">
                ...
                <div class="col-md-8">
                    <select class="form-control input-sm" name="class" id="Classificationeditable1" minlength='3' maxlength='80' value="<?php echo $class; ?>" required>
                        <option value=""></option>
        ...
        <div class="form-group">
            <div class="col-md-11">
                ...
                <div class="col-md-8">
                    <select class="form-control input-sm" name="category" id="Categoryeditable" minlength='3' maxlength='80' value="<?php echo $category; ?>" required>
                        <option value=""></option>
        ...
        <div class="form-group">
            <div class="col-md-11">
                ...
                <div class="col-md-8">
                    <select class="form-control input-sm" name="agenda" id="Agendaeditable1" value="<?php echo $agenda; ?>" minlength='3' maxlength='100' required>
                        <option value=""></option>
                ...
                <div class="col-md-8">
                    <table class="table table-bordered" id="dynamic_field">
                        <tr>
                            ...
                            { 
                                $c=0;
                                $fecthname = $con->query("SELECT RcName FROM rc_name WHERE CitationId = '$record'");
                                while($var = $fecthname->fetch_assoc())
                                {  
                                    $researchersname = $var['RcName'];
                                    if($c==0)
                                    {
        ...
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                ...
                <div class="col-md-8">
                    <select class="form-control input-sm" name="involve" id="Involvementeditable1" value="<?php echo $involve; ?>" required>
                        <option value=""></option>
        ...
        <div class="form-group">
            <div class="col-md-11">
                ...
                <div class="col-md-8">
                    <select class="form-control input-sm" name="type" id="Typeeditable1" value="<?php echo $type; ?>" required>
                        <option value=""></option>
            ...
            <div class="col-md-11">
                ...
                <div class="col-md-8" style="margin-bottom:15px;">	
                    <?php
                        ...
                        if(mysqli_num_rows($query_run)>0)
                        {          
                            $fecthwords = $con->query("SELECT RcKeyword FROM rc_keywords WHERE CitationId = '$record'");
                            while($rows = $fecthwords->fetch_assoc())
                            {  
                                $words = $rows['RcKeyword'];
                                echo "<input name = 'keyword[]' class='form-control input-sm' type='text' value='".$words."' minlength='3' maxlength='20' onkeyup='javascript:capitalize(this.id, this.value);' autocomplete='off' required>";
                            }
        ...
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Title of Research/Article Cited:</label>
                <div class="col-md-8">
                    <input name="article" class="form-control input-sm" placeholder="" type="text" value="<?php echo $article; ?>" minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Title of Article Where Your Research has been cited:</label>
                <div class="col-md-8">
                    <input name="research" class="form-control input-sm" placeholder="" type="text" value="<?php echo $research; ?>" minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Author/s Who Cited Your Research:</label>
                <div class="col-md-8">
                    <input name="authors" class="form-control input-sm" placeholder="" type="text" value="<?php echo $authors; ?>" minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Title of the Journal/Books Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <input name="journals" class="form-control input-sm" placeholder="" type="text" value="<?php echo $journals; ?>"  minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Volume No. of  the Journal/Book Where Your Article has been cited:</label>
                <div class="col-md-8">
        ...
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Issue No. of  the Journal/Book Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <input name="issue" class="form-control input-sm" placeholder="" type="text" value="<?php echo $issue; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label" for="FNAME">Page No. of  the Journal Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <input name="journalpage" class="form-control input-sm" placeholder="" type="text" value="<?php echo $journalpage; ?>" onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label" for="FNAME">Year of Publication of the Journal Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <input name="journalyear" class="form-control input-sm" placeholder="" type="text" value="<?php echo $journalyear; ?>" minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label">Name of Publisher of the Journal Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <input name="journalpublisher" class="form-control input-sm" placeholder="" type="text" value="<?php echo $journalpublisher; ?>" minlength='3' maxlength='100' onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off" required>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-11"style="margin-bottom:15px;">
                <label class="col-md-4 control-label" for="FNAME">Indexing Platform of the Journal Where Your Article has been cited:</label>
                <div class="col-md-8">
                    <select class="form-control input-sm" name="journalindexing" id="Indexditable" value="<?php echo $journalindexing; ?>" minlength='3' maxlength='100' required>
                        <option value=""></option>
                        ...
                        <option value="Exellence">Excellence in Research for Australia</option>  
...
<script type="text/javascript">
    document.getElementById("skipbtn").onclick = function () {
        <?php
            ...
            mysqli_query($con,$stat);
        ?>
        location.href = "ResearchUtilization.php";
    };
</script>
<script type="text/javascript">
