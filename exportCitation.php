...
if(isset($_POST['col7']))
{
    $year = $_POST['thisyear7'];
    $col = $_POST['col7'];
    $request = $_POST['indexing7'];
...
<table border="1" style="align-items:center;" class="table-main">
    <h4>A.4. Research Citation</h4>
        ...
        <tbody>
            ...
            header("Content-Disposition:attachment; filename= $col $displayyear Indexing Platform-$request Research Citation Titles.xls");
            $i = 1;
            $n = null;
            while($row1 = mysqli_fetch_assoc($result4))
            {
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo $row1['RcJournalsCitedBy'];?></td>
