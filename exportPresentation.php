...
{
    $request = $_POST['level6'];
    $col = $_POST['col6'];
    $year = $_POST['thisyear6'];
    ...
    <h4>A.3. Research Presentation</h4>
        ...
        <tbody>
            <?php
             ...
             header("Content-Disposition:attachment; filename= $col $displayyear Level:$request Research Presentation Titles.xls");
            $i = 1;
            $n = null;
            while($row1 = mysqli_fetch_assoc($result2))
            {
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;"><?php echo $row1['RpresConTitle'];?></td>
